import { RenderViewRef, RenderEventDispatcher, RenderTemplateCmd, RenderProtoViewRef, RenderFragmentRef } from './api';
export declare class DefaultProtoViewRef extends RenderProtoViewRef {
    cmds: RenderTemplateCmd[];
    constructor(cmds: RenderTemplateCmd[]);
}
...
export declare class DefaultRenderView<N> extends RenderViewRef {
    ...
    constructor(fragments: DefaultRenderFragmentRef<N>[], boundTextNodes: N[], boundElements: N[], nativeShadowRoots: N[], globalEventAdders: Function[]);
    hydrate(): void;
    dehydrate(): void;
