 ...
 * the UI thread.
 */
export declare function applicationDomBindings(): Array<Type | Binding | any[]>;
/**
 ...
 */
export declare function platform(bindings?: Array<Type | Binding | any[]>): PlatformRef;
/**
 ...
 */
export declare function commonBootstrap(appComponentType: any, appBindings?: Array<Type | Binding | any[]>): Promise<ComponentRef>;
