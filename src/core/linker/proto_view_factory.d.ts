...
export declare class ProtoViewFactory {
    ...
    private _bindPipe(typeOrBinding);
    private _flattenPipes(view);
}
export declare function createDirectiveVariableBindings(variableNameAndValues: Array<string | number>, directiveBindings: DirectiveBinding[]): Map<string, number>;
