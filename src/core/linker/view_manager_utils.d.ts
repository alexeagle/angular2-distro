...
export declare class AppViewManagerUtils {
    ...
    hydrateViewInContainer(parentView: viewModule.AppView, boundElementIndex: number, contextView: viewModule.AppView, contextBoundElementIndex: number, index: number, imperativelyCreatedBindings: ResolvedBinding[]): void;
