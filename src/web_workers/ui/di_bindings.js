...
function _injectorBindings() {
    return [
        ...
        di_1.bind(view_manager_1.AppViewManager).toClass(view_manager_1.AppViewManager_),
        ...
        di_1.bind(exceptions_1.ExceptionHandler).toFactory(function () { return new exceptions_1.ExceptionHandler(dom_adapter_1.DOM); }, []),
        di_1.bind(xhr_1.XHR).toValue(new xhr_impl_1.XHRImpl()),
        url_resolver_1.UrlResolver,
        di_1.bind(dynamic_component_loader_1.DynamicComponentLoader).toClass(dynamic_component_loader_1.DynamicComponentLoader_),
