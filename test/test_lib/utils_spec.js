...
function main() {
    test_lib_1.describe('BrowserDetection', function () {
        var browsers = [
            {
                name: 'Chrome',
        ...
        browsers.forEach(function (browser) {
            test_lib_1.it("should detect " + collection_1.StringMapWrapper.get(browser, 'name'), function () {
                var bd = new test_lib_1.BrowserDetection(collection_1.StringMapWrapper.get(browser, 'ua'));
                test_lib_1.expect(bd.isFirefox).toBe(collection_1.StringMapWrapper.get(browser, 'isFirefox'));
                test_lib_1.expect(bd.isAndroid).toBe(collection_1.StringMapWrapper.get(browser, 'isAndroid'));
                test_lib_1.expect(bd.isEdge).toBe(collection_1.StringMapWrapper.get(browser, 'isEdge'));
                test_lib_1.expect(bd.isIE).toBe(collection_1.StringMapWrapper.get(browser, 'isIE'));
                test_lib_1.expect(bd.isWebkit).toBe(collection_1.StringMapWrapper.get(browser, 'isWebkit'));
                test_lib_1.expect(bd.isIOS7).toBe(collection_1.StringMapWrapper.get(browser, 'isIOS7'));
                test_lib_1.expect(bd.isSlow).toBe(collection_1.StringMapWrapper.get(browser, 'isSlow'));
                test_lib_1.expect(bd.supportsIntlApi).toBe(collection_1.StringMapWrapper.get(browser, 'supportsIntlApi'));
            });
        });
    });
}
