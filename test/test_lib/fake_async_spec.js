...
function main() {
    test_lib_1.describe('fake async', function () {
        ...
        test_lib_1.it('should flush microtasks before returning', function () {
            var thenRan = false;
            test_lib_1.fakeAsync(function () { async_1.PromiseWrapper.resolve(null).then(function (_) { thenRan = true; }); })();
            test_lib_1.expect(thenRan).toEqual(true);
        });
        test_lib_1.it('should propagate the return value', function () { test_lib_1.expect(test_lib_1.fakeAsync(function () { return 'foo'; })()).toEqual('foo'); });
        test_lib_1.describe('Promise', function () {
            ...
            test_lib_1.it('should complain if a test throws an exception', function () {
                test_lib_1.expect(function () { test_lib_1.fakeAsync(function () { throw new exceptions_1.BaseException('sync'); })(); })
                    .toThrowError('sync');
            });
        });
