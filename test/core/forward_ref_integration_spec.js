...
function main() {
    test_lib_1.describe("forwardRef integration", function () {
        test_lib_1.it('should instantiate components which are declared using forwardRef', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
            tcb.createAsync(App).then(function (tc) {
                tc.detectChanges();
                test_lib_1.expect(debug_1.asNativeElements(tc.debugElement.componentViewChildren))
...
var App = (function () {
    ...
    App = __decorate([
        core_1.Component({ selector: 'app', viewBindings: [core_1.forwardRef(function () { return Frame; })] }),
        core_1.View({
