    ...
    test_lib_1.describe('AppViewManagerUtils', function () {
        ...
        test_lib_1.describe('shared hydrate functionality', function () {
            ...
            test_lib_1.it("should set up event listeners", function () {
                ...
                test_lib_1.SpyObject.stub(hostView.elementInjectors[0], { 'getEventEmitterAccessors': [[spyEventAccessor1]], 'getDirectiveAtIndex': dir });
                var spyEventAccessor2 = test_lib_1.SpyObject.stub({ "subscribe": null });
                test_lib_1.SpyObject.stub(hostView.elementInjectors[1], { 'getEventEmitterAccessors': [[spyEventAccessor2]], 'getDirectiveAtIndex': dir });
                utils.hydrateRootHostView(hostView, createInjector());
        ...
        test_lib_1.describe('attachViewInContainer', function () {
            ...
            test_lib_1.it('should not modify the rootElementInjectors at the given context view', function () {
                createViews();
                utils.attachViewInContainer(parentView, 0, contextView, 0, 0, childView);
                test_lib_1.expect(contextView.rootElementInjectors.length).toEqual(1);
            });
            test_lib_1.it('should link the views rootElementInjectors after the elementInjector at the given context', function () {
                ...
                test_lib_1.expect(childView.rootElementInjectors[0].spy('link'))
...
function createElementInjector(parent) {
    ...
    var res = test_lib_1.SpyObject.stub(elementInjector, {
...
function createNestedElBinder(nestedProtoView) {
    ...
    return new element_binder_1.ElementBinder(0, null, 0, createProtoElInjector(), componentBinding, nestedProtoView);
}
...
function _createProtoView(type, binders) {
    ...
    var res = new view_1.AppProtoView([], type, true, function (_) { return new spies_1.SpyChangeDetector(); }, new Map(), null);
