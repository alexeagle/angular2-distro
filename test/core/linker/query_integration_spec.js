...
function main() {
    ...
    test_lib_1.describe('Query API', function () {
        test_lib_1.describe("querying by directive type", function () {
            test_lib_1.it('should contain all direct child directives in the light dom (constructor)', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    .then(function (view) {
                    view.detectChanges();
                    test_lib_1.expect(debug_1.asNativeElements(view.debugElement.componentViewChildren))
                        .toHaveText('2|3|');
                    async.done();
                });
            }));
            test_lib_1.it('should contain all direct child directives in the content dom', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    view.detectChanges();
                    test_lib_1.expect(q.textDirChildren.length).toEqual(1);
                    test_lib_1.expect(q.numberOfChildrenAfterContentInit).toEqual(1);
                    async.done();
                });
            }));
            test_lib_1.it('should contain the first content child', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    view.detectChanges();
                    var q = view.debugElement.componentViewChildren[0].getLocal('q');
                    test_lib_1.expect(q.log).toEqual([["setter", "foo"], ["init", "foo"], ["check", "foo"]]);
                    view.debugElement.componentInstance.shouldShow = false;
                    view.detectChanges();
                    test_lib_1.expect(q.log).toEqual([
                        ["setter", "foo"],
                        ["init", "foo"],
                        ["check", "foo"],
                        ["setter", null],
            ...
            test_lib_1.it('should contain the first view child', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
            ...
            test_lib_1.it('should reflect dynamically inserted directives', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    .then(function (view) {
                    view.detectChanges();
                    test_lib_1.expect(debug_1.asNativeElements(view.debugElement.componentViewChildren)).toHaveText('2|');
                    view.debugElement.componentInstance.shouldShow = true;
                    view.detectChanges();
                    test_lib_1.expect(debug_1.asNativeElements(view.debugElement.componentViewChildren))
                        .toHaveText('2|3|');
            ...
            test_lib_1.it('should be cleanly destroyed when a query crosses view boundaries', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                var template = '<div text="1"></div>' +
                    '<needs-query text="2"><div *ng-if="shouldShow" [text]="\'3\'"></div></needs-query>' +
                    '<div text="4"></div>';
                tcb.overrideTemplate(MyComp, template)
        ...
        test_lib_1.describe('query for TemplateRef', function () {
            test_lib_1.it('should find TemplateRefs in the light and shadow dom', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    test_lib_1.expect(needsTpl.query.first.hasLocal('light')).toBe(true);
                    test_lib_1.expect(needsTpl.viewQuery.first.hasLocal('shadow')).toBe(true);
                    async.done();
                });
            }));
        });
        test_lib_1.describe("changes", function () {
            ...
            test_lib_1.it('should correctly clean-up when destroyed together with the directives it is querying', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    test_lib_1.expect(q2.query.length).toEqual(1);
                    async.done();
                });
            }));
        });
        test_lib_1.describe("querying by var binding", function () {
            ...
            test_lib_1.it('should support querying the view by using a view query', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    var q = view.debugElement.componentViewChildren[0].getLocal("q");
                    view.detectChanges();
                    test_lib_1.expect(q.query.first.nativeElement).toHaveText("text");
                    async.done();
                });
            }));
            test_lib_1.it('should contain all child directives in the view dom', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    view.detectChanges();
                    test_lib_1.expect(q.textDirChildren.length).toEqual(1);
                    test_lib_1.expect(q.numberOfChildrenAfterViewInit).toEqual(1);
                    async.done();
                });
            }));
        });
        test_lib_1.describe("querying in the view", function () {
            ...
            test_lib_1.it('should not include directive present on the host element', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
            ...
            test_lib_1.it('should reflect changes in the component', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    q.show = true;
                    view.detectChanges();
                    test_lib_1.expect(q.query.length).toBe(1);
                    test_lib_1.expect(q.query.first.text).toEqual("1");
                    async.done();
                });
            }));
            ...
            test_lib_1.it('should maintain directives in pre-order depth-first DOM order after dynamic insertion', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    q.list = ["-3", "2"];
                    view.detectChanges();
                    test_lib_1.expect(q.query.map(function (d) { return d.text; })).toEqual(["1", "-3", "2", "4"]);
                    async.done();
                });
            }));
            test_lib_1.it('should maintain directives in pre-order depth-first DOM order after dynamic insertion', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
            ...
            test_lib_1.it('should handle long ng-for cycles', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                var template = '<needs-view-query-order #q></needs-view-query-order>';
                tcb.overrideTemplate(MyComp, template)
                    .createAsync(MyComp)
                    .then(function (view) {
                    ...
                    for (var i = 0; i < 50; i++) {
                        ...
                        q.list = [newString];
                        view.detectChanges();
                        test_lib_1.expect(q.query.map(function (d) { return d.text; })).toEqual(['1', newString, '4']);
                    }
                    async.done();
                });
            }));
            test_lib_1.it('should support more than three queries', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.AsyncTestCompleter], function (tcb, async) {
                ...
                tcb.overrideTemplate(MyComp, template)
                    ...
                    view.detectChanges();
                    var q = view.debugElement.componentViewChildren[0].getLocal('q');
                    test_lib_1.expect(q.query1).toBeDefined();
                    test_lib_1.expect(q.query2).toBeDefined();
                    test_lib_1.expect(q.query3).toBeDefined();
                    test_lib_1.expect(q.query4).toBeDefined();
                    async.done();
                });
            }));
        });
