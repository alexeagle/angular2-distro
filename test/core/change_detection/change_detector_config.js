...
function getDefinition(id) {
    var genConfig = new change_detection_1.ChangeDetectorGenConfig(true, true, true, true);
    var testDef = null;
    if (collection_1.StringMapWrapper.contains(_ExpressionWithLocals.availableDefinitions, id)) {
        ...
        var genConfig = new change_detection_1.ChangeDetectorGenConfig(false, false, false, true);
