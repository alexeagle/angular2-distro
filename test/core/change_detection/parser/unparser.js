...
var Unparser = (function () {
    ...
    Unparser.prototype.visitIf = function (ast) {
        this._expression += 'if (';
        this._visit(ast.condition);
        this._expression += ') ';
        this._visitExpOrBlock(ast.trueExp);
        if (lang_1.isPresent(ast.falseExp)) {
    ...
    Unparser.prototype._visitExpOrBlock = function (ast) {
        var isBlock = ast instanceof ast_1.Chain || ast instanceof ast_1.EmptyExpr;
        if (isBlock)
            this._expression += '{ ';
        this._visit(ast);
        if (isBlock)
