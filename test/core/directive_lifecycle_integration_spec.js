...
function main() {
    test_lib_1.describe('directive lifecycle integration spec', function () {
        test_lib_1.it('should invoke lifecycle methods onChanges > onInit > doCheck > afterContentChecked', test_lib_1.inject([test_lib_1.TestComponentBuilder, test_lib_1.Log, test_lib_1.AsyncTestCompleter], function (tcb, log, async) {
...
var LifecycleDir = (function () {
    ...
    LifecycleDir = __decorate([
        ...
        __metadata('design:paramtypes', [test_lib_1.Log])
    ], LifecycleDir);
    return LifecycleDir;
})();
